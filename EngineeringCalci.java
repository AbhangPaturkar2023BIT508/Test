...
public class EngineeringCalci {
	 ...
	 */
	float additionTwoNumber(int num1, int num2) {
	 ...
	 */
	float subtractionTwoNumber(int num1, int num2) {
		int result; // Initialize variable result to store result
	 ...
	 */
	float mulitplyTwoNumber(int num1, int num2) {
		int result; // Initialize variable result to store result
	 ...
	 */
	float divideTwoNumber(int num1, int num2) {
		int result; // Initialize variable result to store result
	 ...
	 */
	float percentage(int value, int percent) {
